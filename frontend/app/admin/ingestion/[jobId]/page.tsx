    ...
    <PageShell
      ...
      <div className='space-y-5'>
        ...
        <motion.section
          ...
          animate='show'
          custom={0}
          className='bg-white border border-neutral-border rounded-2xl p-6 shadow-surface'>
        ...
        {data.errors.length > 0 && (
          <motion.section
            ...
            animate='show'
            custom={1}
            className='bg-white border border-gov-copper/30 rounded-2xl p-5 shadow-surface'>
...
function StatusBadge({ status, hasErrors }: { status: string; hasErrors: boolean }) {
  const config = ((): {
    ...
    switch (status) {
      ...
      case 'pending':
        return { bg: 'bg-gov-cream', text: 'text-neutral-muted', icon: Clock, label: status };
      default:
        return { bg: 'bg-gov-cream', text: 'text-neutral-muted', icon: Clock, label: status };
    }
  })();
