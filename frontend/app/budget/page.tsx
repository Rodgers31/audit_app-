...
export default function BudgetSpendingPage() {
  ...
  return (
    <PageShell
      ...
      subtitle='Understanding how your tax money is allocated across different sectors'>
      {/* Year Filter */}
      <motion.section
            ...
            {currentData.allocations.map((allocation: any) => {
              ...
              return (
                <div key={allocation.sector} className='text-center p-4 rounded-2xl bg-gray-50'>
                  ...
                  <h4 className='font-semibold text-gray-900 text-sm mb-1'>{allocation.sector}</h4>
