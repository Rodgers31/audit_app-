  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 p-6 animate-pulse">
      ...
      <div className="max-w-7xl mx-auto mb-8">
        ...
        <div className="h-4 w-96 bg-slate-100 dark:bg-surface-elevated rounded" />
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white dark:bg-surface-base rounded-xl p-6 shadow-sm border border-slate-100 h-80" />
        <div className="bg-white dark:bg-surface-base rounded-xl p-6 shadow-sm border border-slate-100 h-80" />
      </div>
    </div>
  );
