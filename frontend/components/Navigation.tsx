    ...
    <>
      <motion.header
        ...
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrolled
            ? 'bg-gov-dark/95 backdrop-blur-xl shadow-lg py-3 border-b border-white/5'
            : 'bg-transparent py-6'
        }`}
      >
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
             ...
             <div className="text-white/40 text-sm font-medium uppercase tracking-widest">Republic of Kenya</div>
          </motion.div>
        )}
      </AnimatePresence>
    </>
